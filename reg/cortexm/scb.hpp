...
struct Scb {
    ...
    struct Shpr {
        Shpr() {}
        Shpr(uint32_t raw0, uint32_t raw1, uint32_t raw2) { r[0] = raw0; r[1] = raw1; r[2] = raw2; }
        union {
            uint32_t r[3];
            struct {
