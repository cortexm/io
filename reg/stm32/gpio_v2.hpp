...
struct Gpio {
    ...
    */
    ...
    struct Afr {
        Afr() {}
        Afr(uint32_t raw0, uint32_t raw1) { r[0] = raw0; r[1] = raw1; }
        union {
            uint32_t r[2];
            struct {
