...
static const size_t USART1 = 0x40011000;
...
static const size_t UART7 = 0x40007800;
static const size_t UART8 = 0x40007C00;
...
static Usart &UART7 = *reinterpret_cast<Usart *>(base::UART7);
static Usart &UART8 = *reinterpret_cast<Usart *>(base::UART8);
